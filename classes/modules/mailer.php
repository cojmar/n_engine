...
class mailer extends n_class
{
	public function __construct()
	{
		$this->mail_cfg = $this->cfg('smtp_email');
		if (empty($this->mail_cfg)) $this->mail_cfg =
		array
		(
			'host'		=>	'',
			'port'		=>	587  ,
	...
	public function send_mail($email,$message)
	{
		...
		$mail->Host = $this->mail_cfg['host'];

		//Set the SMTP port number - 587 for authenticated TLS, a.k.a. RFC4409 SMTP submission
		$mail->Port = $this->mail_cfg['port'];
		...
		$mail->Username = $this->mail_cfg['user'];
		$mail->my_name = $this->mail_cfg['name'];

		//Password to use for SMTP authentication
		$mail->Password = $this->mail_cfg['pass'];

		//Set who the message is to be sent from
		$mail->setFrom($this->mail_cfg['mail'], $mail->my_name);

        $mail->addReplyTo($this->mail_cfg['mail'], $mail->my_name);

		//Set who the message is to be sent to
		$mail->addAddress($email);

		//Set the subject line
		$mail->Subject = $this->mail_cfg['subject'];
